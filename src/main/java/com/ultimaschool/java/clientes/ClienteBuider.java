...
public class ClienteBuider {
    ...
    public ClienteBuider comIdentificacao(String primeiroNome, String nomesDoMeio, String sobrenome, String cpf,
    ...
    public ClienteBuider comContatos(String email, String endereco,String telefone){
        return this;
    }

    private int definirIdadeAtual() {
        int anoAtual = recuperaAnoAtual();
        int anoNascimento = recuperarNascimento();
        return anoAtual - anoNascimento;

    }
    private int recuperarNascimento(){
        Calendar calendario = Calendar.getInstance();
        Date dataDeNascimentoCliente;
        try {
            dataDeNascimentoCliente = defirFormatoData("").parse(dataDeNascimento);
    ...
    private SimpleDateFormat defirFormatoData(String formatoData){
        if (formatoData == ""){
    ...
    public String toString() {
        return tratamentoGenero() + " " + getNomeCompleto() + ", com CPF " +
                ...
                " anos, e-email " + getEmail() +
                ", e endereço " + getEndereco() +
                ",telefone " + getTelefone();
    }
    public String toStringIdentificao() {
